  ...
  <div class="flex max-w-7xl mx-auto mt-8 px-4"> 
    ...
    <aside class="w-1/4 bg-[#DD0000] text-white rounded shadow p-4"> 
      ...
      <ul class="space-y-2">
        ...
        <li><a href="logout.php" onclick="return confirm('Apakah anda yakin ingin keluar?');" class="block text-black hover:underline font-medium">Logout</a></li> 
      </ul> 
    </aside> 
      ...
      <form action="proses_add_about.php" method="post" class="space-y-6"> 
        <div> 
          ...
          <textarea id="about" name="about" rows="6" required 
            class="w-full p-2 border rounded focus:outline-none focus:ring focus:border-[#DD0000]"></textarea> 
        </div> 
        <div class="flex justify-end space-x-4"> 
          <button type="submit" 
            class="bg-[#DD0000] text-white px-4 py-2 rounded hover:bg-black transition">Simpan</button> 
          <a href="about.php" 
